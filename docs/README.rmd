...
To download the latest stable version of PHYLACINE (Version 1.2) or to read our detailed metadata, vist our archive on [DataDryad][dryad-data] **(This link will go live once the manuscript has been published)**.

To play around with the latest development version of PHYLACINE, fork our repo or click [here][github-data] **(This link will go live once the manuscript has been published)**.
...
If you have an error to report or a suggestion to improve the database, please contact us through this [form][error-form] or start a pull request.
...
[error-form]: https://docs.google.com/forms/d/e/1FAIpQLSeo0vEbt7IO6DV0FXLt8wzgXVXEcw2lYHzJeItbA_CiM-PjSw/viewform?usp=sf_link
[dryad-data]: www.datadryad.org
[github-data]: https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/MegaPast2Future/PHYLACINE_1.2/tree/master/Data